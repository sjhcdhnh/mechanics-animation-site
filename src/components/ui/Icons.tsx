/** Minimal SVG icon set — replaces all emoji usage across the site. */

export function LogoIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="5" cy="5" r="2.5" />
      <line x1="5" y1="7.5" x2="5" y2="19" />
      <line x1="2" y1="19" x2="8" y2="19" />
      <circle cx="5" cy="19" r="2.5" />
      <line x1="10" y1="19" x2="22" y2="19" />
      <rect x="12" y="3" width="3" height="9" rx="1.5" />
      <rect x="16" y="4.5" width="3" height="7.5" rx="1.5" />
    </svg>
  );
}
...
export function AlertIcon({ className = 'w-10 h-10' }: { className?: string }) {
  return (
...
export function EmptyIcon({ className = 'w-12 h-12' }: { className?: string }) {
  return (
...
export function MouseIcon({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
